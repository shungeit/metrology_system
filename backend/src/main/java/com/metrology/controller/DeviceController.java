...
public class DeviceController {
    ...
    public ResponseEntity<?> listPaged(
        ...
        return ResponseEntity.ok(deviceService.getDevicesPaged(
                userDetails.getUsername(), search, assetNo, serialNo, dept, validity, responsiblePerson, useStatus, page, size));
    }
    ...
    public ResponseEntity<?> create(
        ...
        return ResponseEntity.ok(deviceService.createDevice(userDetails.getUsername(), dto));
    }
